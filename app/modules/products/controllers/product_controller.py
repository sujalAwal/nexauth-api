...
async def list_products(
    ...
    try:
        ...
        result = await service.get_products_paginated(search=search, sort=sort, page=page, limit=limit)
...
async def get_product_by_name(
    ...
    try:
        service = ProductService(db)
        product = await service.get_product_by_name(name)
...
async def get_products_by_brand(
    ...
    try:
        service = ProductService(db)
        products = await service.get_products_by_brand(brand_id)
...
async def get_products_on_sale(
    ...
    try:
        service = ProductService(db)
        products = await service.get_products_on_sale()
...
async def create_product(
    ...
    try:
        service = ProductService(db)
        product = await service.create_product(product_request, created_by=UUID(int=0))
...
async def update_product(
    ...
    try:
        service = ProductService(db)
        product = await service.update_product(product_id, product_request, updated_by=UUID(int=0))
...
async def delete_product(
    ...
    try:
        service = ProductService(db)
        product = await service.delete_product(product_id, deleted_by=UUID(int=0))
